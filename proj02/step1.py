...
slab3 = slab1.copy()
del slab3[range(421,431)+range(442,451)+range(462,470)+range(483,490)+range(503,509)+range(524,529)+range(544,548)+range(565,568)+range(585,587)+[606]]
...
traj = Trajectory('md-Fe.traj', 'w', slab3)
